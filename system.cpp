...
bool install_system()
{
    ...
    fflush(fr);
    cout<<"s b f n: "<<superblock->s_free_inode_num<<endl;
...
bool format()
{
    ...
    cout<<"formatting superblock: "<<superblock->s_free_inode_num<<endl;
    ...
    while (i < 160)
    {
        ...
        for (j = 0; j < 16; j++)
        {
            if (strcmp(dirlist[j].item_name, name) == 0)
            {
                ...
                cout << "To copy inode: " << copy_to_paste_inode_address << endl;
                return true;
            }
            i += 1;
        }
